...
export class PatientsController {
  ...
  @ApiQuery({ name: 'visitFrom',        required: false, type: String, description: 'ISO date e.g. 2024-01-01' })
  @ApiQuery({ name: 'visitTo',          required: false, type: String, description: 'ISO date e.g. 2024-12-31' })
  @ApiQuery({ name: 'dobFrom',          required: false, type: String, description: 'ISO date e.g. 1990-01-01' })
  @ApiQuery({ name: 'dobTo',            required: false, type: String, description: 'ISO date e.g. 2005-12-31' })
  @ApiQuery({ name: 'sortBy',           required: false, enum: ['createdAt','updatedAt','firstNameEn','lastNameEn','dob','appointments'] })
