...
const getColumns = (t: Translations, lang: string) => [
  ...
  { header: t.exports.email, value: (p: Practitioner) => p.email ?? '' },
  {
    ...
    value: (p: Practitioner) => formatPhoneDisplay(p.phone) || p.phone || '',
  },
  {
    header: t.exports.department,
    value: (p: Practitioner) => p.departmentName ?? '',
  },
  {
    header: t.exports.specialty,
    value: (p: Practitioner) => p.specialty ?? '',
  },
  {
    header: t.exports.employment,
    value: (p: Practitioner) =>
      p.employmentType
  ...
  {
    header: t.exports.languages,
    value: (p: Practitioner) => languageLabels(p.languages, t),
  },
  {
    header: t.exports.license,
    value: (p: Practitioner) => p.licenseNumber ?? '',
  },
  {
    header: t.exports.licenseExpiry,
    value: (p: Practitioner) =>
      p.licenseExpiry ? p.licenseExpiry.slice(0, 10) : '',
  },
  {
    header: t.exports.experience,
    value: (p: Practitioner) => p.experienceYears ?? '',
  },
  {
    header: t.exports.room,
    value: (p: Practitioner) => p.defaultRoomName ?? '',
  },
  {
    header: t.exports.gender,
    value: (p: Practitioner) => genderLabel(p.gender, t),
  },
  {
    header: t.exports.nationality,
    value: (p: Practitioner) => p.nationality ?? '',
  },
  {
