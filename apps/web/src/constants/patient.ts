  ...
  [
    {
      ...
      label: t.constants.patientSorts['createdAt:desc'],
    },
    {
      value: 'createdAt:asc',
      label: t.constants.patientSorts['createdAt:asc'],
    },
    {
      value: 'firstNameEn:asc',
      label: t.constants.patientSorts['firstNameEn:asc'],
    },
    {
      value: 'firstNameEn:desc',
      label: t.constants.patientSorts['firstNameEn:desc'],
    },
    {
      value: 'lastNameEn:asc',
      label: t.constants.patientSorts['lastNameEn:asc'],
    },
    {
      value: 'appointments:desc',
      label: t.constants.patientSorts['appointments:desc'],
    },
