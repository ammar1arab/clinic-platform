...
const badgeVariants = cva(
  "group/badge inline-flex min-h-5 w-fit max-w-full shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-4xl border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-all text-start [&>span:not([class*='rounded-full'])]:truncate focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-[>span.rounded-full:first-child]:ps-1.5 has-[>span.rounded-full:last-child]:pe-1.5 has-data-[icon=inline-end]:pe-1.5 has-data-[icon=inline-start]:ps-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
