...
import { WEEKDAY_OPTIONS } from '@/components/blocks/practitioners/practitioner-form.mapper';
    ...
    <div className="mx-auto max-w-4xl space-y-4">
      ...
      <Card className="overflow-hidden border-border/60 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {practitioner.employmentType ? (
                <Badge variant="outline" className="font-normal">
                  {EMPLOYMENT_LABEL[practitioner.employmentType] ??
                    practitioner.employmentType}
                </Badge>
              ) : null}
            </div>
        ...
        <div className="flex divide-x divide-border/70">
          <Stat label="Services" value={String(practitioner.services.length)} />
          <Stat label="Buffer" value={`${practitioner.bufferMins}m`} />
          <Stat
            label="Experience"
            value={
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-medium">Credentialed services</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-border/60 shadow-sm">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">Leave / blocked time</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
